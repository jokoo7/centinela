...
> = {
  ...
  meta: {
    modelProps: 'user' | 'vaultItem' | 'session' | 'account' | 'verification';
...
export type VaultItemScalarFieldEnum =
  (typeof VaultItemScalarFieldEnum)[keyof typeof VaultItemScalarFieldEnum];
 ...
 */
export type EnumVaultItemTypeFieldRefInput<$PrismaModel> = FieldRefInputType<
  $PrismaModel,
  'VaultItemType'
>;
 ...
 * Reference to a field of type 'VaultItemType[]'
 */
export type ListEnumVaultItemTypeFieldRefInput<$PrismaModel> = FieldRefInputType<
  $PrismaModel,
  'VaultItemType[]'
>;
